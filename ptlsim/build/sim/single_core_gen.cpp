...
int single_core_handle_cpuid(uint32_t index, uint32_t count, uint32_t *eax, uint32_t *ebx,
...
void gen_single_core_machine(BaseMachine& machine)
{


    while(!machine.context_used.allset()) {

        machine.add_option("ooo_", machine.coreid_counter, "threads", 1);
    ...
    machine.handle_cpuid = &single_core_handle_cpuid;
...
MachineBuilder single_core("single_core", &gen_single_core_machine);
