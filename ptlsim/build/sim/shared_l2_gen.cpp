...
int shared_l2_handle_cpuid(uint32_t index, uint32_t count, uint32_t *eax, uint32_t *ebx,
...
void gen_shared_l2_machine(BaseMachine& machine)
{
    ...
    machine.handle_cpuid = &shared_l2_handle_cpuid;
...
MachineBuilder shared_l2("shared_l2", &gen_shared_l2_machine);
