...
int private_L2_handle_cpuid(uint32_t index, uint32_t count, uint32_t *eax, uint32_t *ebx,
...
void gen_private_L2_machine(BaseMachine& machine)
{
    ...
    machine.handle_cpuid = &private_L2_handle_cpuid;
...
MachineBuilder private_L2("private_L2", &gen_private_L2_machine);
