...
int ooo_2_th_handle_cpuid(uint32_t index, uint32_t count, uint32_t *eax, uint32_t *ebx,
...
void gen_ooo_2_th_machine(BaseMachine& machine)
{


    while(!machine.context_used.allset()) {

        machine.add_option("ooo_", machine.coreid_counter, "threads", 2);

        CoreBuilder::add_new_core(machine, "ooo_", "ooo_2");
    ...
    foreach(i, machine.get_num_cores()) {
        ...
        ControllerBuilder::add_new_cont(machine, i, "L1_I_", "mesi_cache", L1_128K_MESI);
    ...
    foreach(i, machine.get_num_cores()) {
        ...
        ControllerBuilder::add_new_cont(machine, i, "L1_D_", "mesi_cache", L1_128K_MESI);
    ...
    foreach(i, machine.get_num_cores()) {
        ...
        ControllerBuilder::add_new_cont(machine, i, "L2_", "mesi_cache", L2_2M_MESI);
    ...
    machine.handle_cpuid = &ooo_2_th_handle_cpuid;
...
MachineBuilder ooo_2_th("ooo_2_th", &gen_ooo_2_th_machine);
